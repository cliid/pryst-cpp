...
char* pryst_core_String_substring(void* string_ptr, size_t start, size_t length) {
    try {
        auto str = static_cast<pryst::core::StringImpl*>(string_ptr);
...
char* pryst_core_String_replace(void* string_ptr, const char* from, const char* to) {
    try {
        auto str = static_cast<pryst::core::StringImpl*>(string_ptr);
...
char* pryst_core_String_trim(void* string_ptr) {
    try {
        auto str = static_cast<pryst::core::StringImpl*>(string_ptr);
