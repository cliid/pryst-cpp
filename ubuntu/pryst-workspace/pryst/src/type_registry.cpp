...
bool TypeRegistry::hasClass(const std::string& className) const {
    ...
    // First try exact match in both classTypes and typeCache
    if (classTypes.find(className) != classTypes.end() || typeCache.find(className) != typeCache.end()) {
    ...
    if (lastSeparator != std::string::npos) {
        ...
        if (classTypes.find(shortName) != classTypes.end() || typeCache.find(shortName) != typeCache.end()) {
        ...
        while ((lastSeparator = remainingName.find("::")) != std::string::npos) {
            ...
            if (classTypes.find(tryName) != classTypes.end() || typeCache.find(tryName) != typeCache.end()) {
